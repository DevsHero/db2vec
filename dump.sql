...
--
-- Name: analytics_data_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.analytics_data_id_seq OWNER TO postgres;

--
-- Name: analytics_data_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.products (
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    status public.product_status DEFAULT 'in_stock'::public.product_status,
    tags text[],
    dimensions numeric(10,2)[],
    metadata jsonb,
...
--
-- Name: analytics_data id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: analytics_data_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: idx_content_tags; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: analytics_data analytics_data_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.analytics_data
    ADD CONSTRAINT analytics_data_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: content content_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.content
    ADD CONSTRAINT content_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.users(id);
